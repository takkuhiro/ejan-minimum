...
const tutorialSteps = [
  {
    ...
    tips: ["スポンジを湿らせて使うと自然な仕上がりになります", "首との境目をぼかすことを忘れずに"],
  },
  {
    id: 2,
    name: "アイブロウ",
    duration: 3,
    description: "眉毛を整えて、顔の印象を決定づけます。自然な眉の形に沿って、足りない部分を補いましょう。",
    imageUrl: "/makeup-step-eyebrow.jpg",
    videoUrl: "/makeup-step-eyebrow-video.mp4",
    tips: ["眉頭は薄く、眉尻に向かって濃くするのがポイント", "毛流れに沿って描くと自然に見えます"],
  },
  {
    id: 3,
    name: "アイシャドウ",
    duration: 8,
    description: "目元に深みと立体感を与えます。グラデーションを意識して、自然な陰影を作りましょう。",
    imageUrl: "/makeup-step-eyeshadow.jpg",
    videoUrl: "/makeup-step-eyeshadow-video.mp4",
    tips: ["明るい色から暗い色の順番で重ねる", "ブラシでしっかりぼかすことが大切"],
  },
  {
    id: 4,
    name: "マスカラ",
    duration: 4,
    description: "まつ毛を長く、美しく仕上げます。根元からしっかりと塗り、セパレートさせましょう。",
    imageUrl: "/makeup-step-mascara.jpg",
    videoUrl: "/makeup-step-mascara-video.mp4",
    tips: ["ビューラーで事前にカールをつける", "ダマにならないよう少量ずつ重ねる"],
  },
  {
    id: 5,
    name: "チーク",
    duration: 3,
    description: "頬に血色感をプラスして、健康的な印象を演出します。笑った時に高くなる部分に入れましょう。",
  ...
  },
  {
    ...
    name: "リップ",
    duration: 2,
    description: "最後にリップで全体を仕上げます。唇の形を整えて、美しい口元を作りましょう。",
...
export default function TutorialPage() {
  ...
  const completedDuration = completedSteps.reduce((sum, stepIndex) => sum + tutorialSteps[stepIndex].duration, 0)
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="text-center flex-1">
            ...
            <p className="text-muted-foreground mt-2">ステップバイステップで美しく変身</p>
          </div>
                ...
                {tutorialSteps.map((step, index) => (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      {completedSteps.includes(index) && <CheckCircle className="w-4 h-4 text-green-600" />}
                    </div>
                  </button>
                ))}
              </CardContent>
            ...
            {completedSteps.length === tutorialSteps.length && (
              <Card className="border-green-200 bg-green-50">
                <CardContent className="pt-6 text-center">
                  ...
                  <p className="text-green-700">すべてのステップが完了しました。素晴らしい仕上がりですね！</p>
                </CardContent>
              </Card>
            )}
          </div>
