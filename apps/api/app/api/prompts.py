...
ただし、ステップ数は**最大5ステップまで**にしてください。
このスタイルを学んでいる人にとって、明確でわかりやすい指示にしてください。
出力は基本的に日本語でお願いします。（各stepのtitle_en, description_enは英語で出力してください。）
"""

GENERATE_TUTORIAL_STRUCTURE_PROMPT_JA = """\
与えられたスタイル説明をもとに、ステップバイステップでメイクとヘアスタイルを教えるチュートリアルを作成してください。
ステップバイステップの説明は日本語で作成してください。
ステップバイステップの説明は10ステップ以内で作成してください。
ステップバイステップの説明は100文字以内で作成してください。
ステップバイステップの説明は日本語で作成してください。
ステップバイステップの説明は100文字以内で作成してください。
"""
